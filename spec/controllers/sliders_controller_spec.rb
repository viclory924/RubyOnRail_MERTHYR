  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved slider as @slider" do
        ...
        post :create, {:slider => { "caption" => "invalid value" }}, valid_session
        assigns(:slider).should be_a_new(Slider)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested slider" do
        ...
        Slider.any_instance.should_receive(:update_attributes).with({ "caption" => "MyString" })
        put :update, {:id => slider.to_param, :slider => { "caption" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the slider as @slider" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Slider.any_instance.stub(:save).and_return(false)
        put :update, {:id => slider.to_param, :slider => { "caption" => "invalid value" }}, valid_session
        assigns(:slider).should eq(slider)
      end
